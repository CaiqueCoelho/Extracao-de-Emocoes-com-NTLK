...
print(type(removeStopWords(base)))
...
print(type(basetreinamento))
frasesComStemming = aplicaStemmer(basetreinamento)
frasesTeste = aplicaStemmer(baseteste)
...
palavrasTeste = buscaPalavras(frasesTeste)
#print(palavras)
...
baseCompletaTeste = nltk.classify.apply_features(extratorPalavras, frasesTeste)
